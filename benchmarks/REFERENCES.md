...
3. **n = 2，且只做了 DFT 几何上的单点。** 这**不是** T[E_m] ——
   ...
   **已做**：P1 于 2026-09-04（`docs/experiments/p1_qm/orca/p1_T_Em/`，MACE-OFF24），
   b04 于 2026-09-22（`docs/experiments/b04_qm/T_Em/`，POLAR-1）。
   **本条的 n = 2 仍然成立** —— 它说的是这张表里的单点比较，不是 T[E_m] 的条数。
